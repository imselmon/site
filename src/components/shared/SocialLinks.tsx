  ...
  return (
    <div className="mt-6 flex gap-6">
      ...
      <a
        ...
        target="_blank"
        href="https://twitter.com/imselmon"
      >
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
      ...
      <a
        ...
        target="_blank"
        href="https://instagram.com/imselmon"
      >
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
      ...
      <a
        ...
        target="_blank"
        href="https://github.com/imselmonj"
      >
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
      ...
      <a
        ...
        target="_blank"
        href="https://www.linkedin.com/in/imselmon/"
      >
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
      ...
      <a
        ...
        target="_blank"
        href="https://stackoverflow.com/users/16240219/salman-shaikh"
      >
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M3 2h18c1.1046 0 2 .8954 2 2v18c0 1.1046-.8954 2-2 2H3c-1.1046 0-2-.8954-2-2V4c0-1.1046.8954-2 2-2zm0 2v18h18V4H3zm8 14h6v2h-6v-2zm0-4h6v2h-6v-2zm0-4h6v2h-6V8z"
          ></path>
        </svg>
      </a>
    </div>
